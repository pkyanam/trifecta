...
const CPU_TIERS = [
  { id: 'launch',  label: 'Launch',  specs: 'Standard snapshot sandbox', icon: Zap,    price: '$0.12/hr' },
  { id: 'build',   label: 'Build',   specs: 'Build-tier access and billing', icon: Rocket, price: '$0.24/hr' },
  { id: 'max-cpu', label: 'Max CPU', specs: 'Team-tier access and billing', icon: Gauge,  price: '$0.48/hr' },
];
...
export function CreateSandboxModal({
  ...
  const diskGiB = DISK_INCLUDED_GIB;
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-xl border border-border bg-card px-3.5 py-3">
              <div className="text-sm font-semibold text-foreground">{diskGiB} GiB</div>
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                Daytona sandboxes currently support up to 10 GiB disk per sandbox.
              </p>
            </div>
          </div>
