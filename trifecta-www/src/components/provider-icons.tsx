...
// NOTE: These are brand logos for AI providers. They are intentionally
// theme-independent — no `dark:` variants, no filters, no dark-only paths.
// They are always rendered on a neutral light tile in the OS, so they keep
// their natural brand colors in both light and dark mode.
...
export const OpenAIIcon = ({ className, ...props }: IconProps) => (
  <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 260" className={cn("fill-black", className)} {...props}>
...
export const CursorProviderIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 466.73 532.09" className={cn("fill-[#26251E]", className)} {...props}>
...
export const OpenCodeProviderIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 32 40" fill="none" className={className} {...props}>
    <path d="M24 32H8V16H24V32Z" fill="#CFCECD" />
    <path d="M24 8H8V32H24V8ZM32 40H0V0H32V40Z" fill="#211E1E" />
  </svg>
)

export const GithubCopilotProviderIcon = ({ className, ...props }: IconProps) => (
  <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 208" className={cn("fill-black", className)} {...props}>
...
export const ACPRegistryProviderIcon = ({ className, ...props }: IconProps) => (
  <svg viewBox="0 0 576 220" fill="none" className={cn("fill-black", className)} {...props}>
