        ...
        <section className="mx-auto max-w-5xl px-6 py-12">
          ...
          <div className="mt-6 rounded-xl border border-white/[0.04] bg-[#080808] p-5">
            ...
            <div className="flex flex-wrap gap-2">
              <a href="https://github.com/pkyanam/trifecta" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-md border border-white/[0.04] bg-white/[0.02] px-3 py-1.5 text-xs text-[#555] transition-colors hover:text-[#ececec] hover:border-white/[0.08]">
