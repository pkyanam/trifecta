...
it("builds a latest Discord announcement for stable subscribers", () => {
  assert.deepStrictEqual(
    buildDiscordReleaseAnnouncement({
      ...
      releaseName: "Trifecta v1.2.3",
      version: "1.2.3",
      tag: "v1.2.3",
      releaseUrl: new URL("https://github.com/t3dotgg/belweave-code/releases/tag/v1.2.3"),
      timestamp: "2026-05-01T01:41:00.000Z",
    }),
    {
      content: "<@&222222222222222222> Latest published: Trifecta v1.2.3",
      allowed_mentions: {
        roles: ["222222222222222222"],
      },
      embeds: [
        {
          title: "Trifecta v1.2.3",
          url: "https://github.com/t3dotgg/belweave-code/releases/tag/v1.2.3",
          description: "A new Trifecta latest release is available.",
          color: 0x2ecc71,
          fields: [
            {
              name: "Version",
