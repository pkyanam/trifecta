// This file mostly exists because we want dev mode to say "Trifecta (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.trifecta.desktop.dev" : "com.trifecta.desktop";
...
function buildMacLauncher(electronBinaryPath) {
  ...
  runChecked("codesign", ["--sign", "-", "--deep", "--force", targetAppBundlePath]);
