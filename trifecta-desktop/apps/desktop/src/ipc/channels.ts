...
export const GET_BELWEAVE_CLOUD_CONFIG_CHANNEL = "desktop:get-belweave-cloud-config";
export const SET_BELWEAVE_CLOUD_CONFIG_CHANNEL = "desktop:set-belweave-cloud-config";
export const GET_BELWEAVE_CLOUD_API_KEY_CHANNEL = "desktop:get-belweave-cloud-api-key";
export const SET_BELWEAVE_CLOUD_API_KEY_CHANNEL = "desktop:set-belweave-cloud-api-key";
export const REMOVE_BELWEAVE_CLOUD_API_KEY_CHANNEL = "desktop:remove-belweave-cloud-api-key";
...
export const FETCH_REMOTE_JSON_CHANNEL = "desktop:fetch-remote-json";
export const FETCH_BELWEAVE_CLOUD_CHANNEL = "desktop:fetch-belweave-cloud";
export const RESOLVE_BOX_WEB_SOCKET_URL_CHANNEL = "desktop:resolve-box-web-socket-url";
