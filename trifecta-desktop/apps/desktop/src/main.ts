...
import { resolveRemoteBelweaveCliPackageSpec } from "@belweave/ssh/command";
import type { RemoteBelweaveRunnerOptions } from "@belweave/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteBelweaveRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteBelweaveServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteBelweaveCliPackageSpec({
