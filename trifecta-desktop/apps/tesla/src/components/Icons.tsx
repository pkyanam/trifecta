...
export const HermesIcon: Icon = ({ className, ...props }) => (
  <svg
    {...props}
    className={cn(
      "overflow-hidden rounded-sm bg-[url('/hermes-logo.jpg')] bg-cover bg-center bg-no-repeat dark:[filter:invert(1)]",
      className,
    )}
    viewBox="0 0 100 100"
...
export const DevinIcon: Icon = ({ className, ...props }) => (
  <svg
    {...props}
    className={cn(
      "overflow-hidden rounded-sm bg-[url('/DevinLogoSquare.png')] bg-cover bg-center bg-no-repeat",
      className,
    )}
    viewBox="0 0 100 100"
    xmlns="http://www.w3.org/2000/svg"
