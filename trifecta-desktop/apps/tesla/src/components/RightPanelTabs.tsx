...
/** Minimal preview session shape for tab titles until preview contracts land. */
...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the Trifecta desktop app.",
...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-[52px] min-h-[52px] shrink-0 items-center border-b border-border/60 gap-1 pl-2",
