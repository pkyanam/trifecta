...
export const CLIENT_SETTINGS_STORAGE_KEY = "trifecta:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "trifecta:saved-environment-registry:v1";
