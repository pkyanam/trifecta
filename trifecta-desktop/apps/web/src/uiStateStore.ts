...
export const PERSISTED_STATE_KEY = "belweave:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "belweave:renderer-state:v8",
  "belweave:renderer-state:v7",
  "belweave:renderer-state:v6",
  "belweave:renderer-state:v5",
  "belweave:renderer-state:v4",
  "belweave:renderer-state:v3",
