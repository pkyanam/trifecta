...
const PIERRE_ICON_SPRITE_ID = "belweave-pierre-file-icon-sprite";

const BELWEAVE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="belweave-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="belweave-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="belweave-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="belweave-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="belweave-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="belweave-file-icon-pnpm" viewBox="0 0 32 32">
...
export const BELWEAVE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: BELWEAVE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "belweave-file-icon-package-json",
    "tsconfig.json": "belweave-file-icon-tsconfig",
    "agents.md": "belweave-file-icon-agents",
    "claude.md": "belweave-file-icon-claude",
    "readme.md": "belweave-file-icon-readme",
    "pnpm-lock.yaml": "belweave-file-icon-pnpm",
    "pnpm-workspace.yaml": "belweave-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(BELWEAVE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${BELWEAVE_FILE_ICON_SPRITE}`;
