...
import { parseScopedThreadKey, scopedThreadKey } from "@belweave/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@belweave/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "belweave:terminal-state:v1";
