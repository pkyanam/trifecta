 ...
 */
import { scopedThreadKey } from "@belweave/client-runtime";
import type { ScopedThreadRef } from "@belweave/contracts";
...
const RIGHT_PANEL_STORAGE_KEY = "belweave:right-panel-state:v1";
