...
import { SourceControlProviderError, type ChangeRequest } from "@belweave/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set BELWEAVE_BITBUCKET_EMAIL and BELWEAVE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
