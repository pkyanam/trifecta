import { type GrokSettings, ProviderDriverKind } from "@belweave/contracts";
import { normalizeModelSlug } from "@belweave/shared/model";
...
const GROK_OAUTH2_REFERRER = "trifecta";
