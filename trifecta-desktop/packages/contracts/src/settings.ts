...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-belweave/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Trifecta spawn the server when needed.",
        providerSettingsForm: {
...
export const HermesSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("hermes").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Hermes binary.",
        providerSettingsForm: {
          placeholder: "hermes",
          clearWhenEmpty: "omit",
        },
...
export const ServerSettings = Schema.Struct({
  ...
  // Trifecta-owned MCP server registry. Injected into ACP agents via
  // `session/new` and synced into each supported agent's native config file.
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  // Full-replace patch: the web UI always sends the entire registry when edited.
