...
This guide is for people who want to use more than one Codex account in Trifecta.
...
In Trifecta Settings, name it something obvious:
...
In Trifecta Settings, add another Codex provider:
...
Trifecta shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, Trifecta treats it
