...
final class QRScannerPairingValidatorTests: XCTestCase {
    func testVersionMismatchRequiresBridgeUpdateBeforeScanning() {
        ...
        XCTAssertEqual(prompt.title, "Update Trifecta on your Mac before scanning")
        XCTAssertEqual(prompt.command, "npm install -g trifecta@latest")
        XCTAssertTrue(prompt.message.contains("different Trifecta npm version"))
    }
    ...
    func testLegacyBridgePayloadRequiresBridgeUpdateBeforeScanning() {
        ...
        XCTAssertEqual(prompt.command, "npm install -g trifecta@latest")
        XCTAssertTrue(prompt.message.contains("older Trifecta bridge"))
    }
