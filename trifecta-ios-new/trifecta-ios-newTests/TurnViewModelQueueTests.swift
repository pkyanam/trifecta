...
final class TurnViewModelQueueTests: XCTestCase {
    ...
    func testSendTurnQueuesImmediatelyWhenThreadBusy() async throws {
        ...
        viewModel.composerMentionedFiles = [
            TurnComposerMentionedFile(
                ...
                path: "trifecta-ios-new/Views/Turn/TurnView.swift"
            )
        ]
        ...
        XCTAssertEqual(queuedDraft.text, "Please inspect @trifecta-ios-new/Views/Turn/TurnView.swift")
    ...
    func testSendTurnStoresOnlyConfirmedFileMentionsOnUserMessage() async {
        ...
        XCTAssertEqual(message.text, "Please inspect @trifecta-ios-new/Views/Turn/TurnView.swift")
        XCTAssertEqual(message.fileMentions, ["trifecta-ios-new/Views/Turn/TurnView.swift"])
    }
    ...
    func testSendTurnDoesNotStoreManualFileLikeTextAsConfirmedMention() async {
        ...
        let viewModel = makeViewModel()
        viewModel.input = "Please inspect @trifecta-ios-new/Views/Turn/TurnView.swift"
    ...
    func testRestoreQueuedDraftMovesSelectedRowIntoComposerAndRemovesItFromQueue() {
        ...
        let second = QueuedTurnDraft(
            id: "draft-restore",
            text: "Please inspect @trifecta-ios-new/Views/Turn/TurnView.swift",
            attachments: [attachment],
            skillMentions: [
                CodexTurnSkillMention(
                    id: "check-code",
        ...
        XCTAssertEqual(viewModel.composerMentionedFiles.map(\.path), ["trifecta-ios-new/Views/Turn/TurnView.swift"])
