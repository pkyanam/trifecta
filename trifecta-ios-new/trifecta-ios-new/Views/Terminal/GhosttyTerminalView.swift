...
final class GhosttyTerminalView: UIView, UITextFieldDelegate {
    ...
    var terminalKey: String = "" {
        didSet {
            accessibilityIdentifier = "trifecta-terminal-\(terminalKey)"
        }
    }
    ...
    private func writeThemeConfigFile() -> String? {
        ...
        let url = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("trifecta-terminal-theme-\(appearance.rawValue).ghostty")
