...
// Exports: GhosttyTerminalSurface, TrifectaTerminalTheme
// Depends on: SwiftUI, GhosttyTerminalView

import Foundation
import SwiftUI

struct TrifectaTerminalTheme: Equatable {
    ...
    static func resolved(for colorScheme: ColorScheme) -> TrifectaTerminalTheme {
    ...
    static let light = TrifectaTerminalTheme(
        background: "#eff1f5",
        foreground: "#4c4f69",
    ...
    static let dark = TrifectaTerminalTheme(
        background: "#101113",
        foreground: "#d7d7dc",
