...
// Depends on: SwiftUI, TrifectaTerminalModels

import SwiftUI

let trifectaTerminalDefaultFontSize = 10.0
let trifectaTerminalFontSizeStep = 0.5
let trifectaTerminalMinFontSize = 6.0
let trifectaTerminalMaxFontSize = 14.0
let trifectaTerminalAccessoryHeight: CGFloat = 52
...
struct TerminalMenuSessionItem: Identifiable {
    ...
    let status: TrifectaTerminalStatus
    let cwd: String
