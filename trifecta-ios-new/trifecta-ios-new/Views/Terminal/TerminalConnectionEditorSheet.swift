...
// Depends on: SwiftUI, UIKit, TrifectaTerminalModels, TrifectaTerminalPrivateKeyStore
...
struct TerminalConnectionEditorSheet: View {
    ...
    @Binding var profile: TrifectaTerminalProfile
    ...
    private var keyLabel: String {
        TrifectaTerminalPrivateKeyStore.hasPrivateKey(privateKey) ? "Imported" : "Import"
    }
    ...
    var body: some View {
        TerminalEditorSection(title: "Authentication") {
            VStack(spacing: 0) {
                ...
                if isShowingKeyEditor || !TrifectaTerminalPrivateKeyStore.hasPrivateKey(privateKey) {
