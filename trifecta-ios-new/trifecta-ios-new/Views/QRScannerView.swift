...
struct QRScannerView: View {
        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                if let command = prompt.command, !command.isEmpty {
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Trifecta", detail: command, showsCopyButton: true)
                    bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run trifecta up")
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Trifecta", detail: "Install the latest Trifecta build on this iPhone.")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan the Trifecta QR code")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        ...
        message: "This QR code was generated by a different Trifecta npm version. Update the package on your computer to the latest release before scanning a new QR code.",
        command: "npm install -g trifecta@latest"
    )
}
