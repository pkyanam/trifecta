...
private struct TurnViewAlertModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .alert("Continue on Desktop App", isPresented: $isShowingMacHandoffConfirm) {
                ...
                Text("Trifecta will force close and reopen Trifecta.app on this computer. Any desktop runs in progress will be stopped, and unsaved draft text there may be lost before this chat is opened.")
            }
            .alert(
    ...
    private func approvalAlertMessage(for request: CodexApprovalRequest) -> String {
        ...
        if lines.isEmpty {
            return "Trifecta is requesting permission to continue."
        }
