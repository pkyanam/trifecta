...
enum TurnComposerMetaMapper {
    ...
    static func modelTitle(for model: CodexModelOption) -> String {
        ...
        return modelTitle(forIdentifier: model.model)
    }
    ...
    static func modelTitle(forIdentifier identifier: String?, fallback: String? = nil) -> String {
        ...
        case "gpt-5.2-codex":
            return "GPT-5.2-Trifecta"
        case "gpt-5.1-codex-max":
            return "GPT-5.1-Trifecta-Max"
        case "gpt-5.4":
            return "GPT-5.4"
        case "gpt-5.4-mini":
            return "GPT-5.4-Mini"
    ...
    // Converts server effort values to user-facing labels while preserving server order.
