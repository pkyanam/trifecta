...
enum TurnVoiceRecoveryPresentationBuilder {
    static func presentation(for reason: CodexVoiceFailureReason) -> VoiceRecoveryPresentation {
        ...
        case .reconnectRequired:
            return VoiceRecoveryPresentation(
                snapshot: snapshot(
                    ...
                    detail: "Keep the Trifecta bridge running on your paired computer, then try the microphone again.",
                    status: .interrupted,
        ...
        case .bridgeSessionUnsupported:
            return VoiceRecoveryPresentation(
                snapshot: snapshot(
                    ...
                    detail: "Restart Trifecta on your computer, then reconnect this iPhone. If it still happens, update Trifecta on your computer and pair again.",
        ...
        case .microphonePermissionRequired:
            return VoiceRecoveryPresentation(
                snapshot: snapshot(
                    summary: "Microphone access is off for Trifecta.",
                    detail: "Open iPhone Settings, allow Microphone for Trifecta, then try recording again.",
                    status: .actionRequired,
        ...
        case .recorderUnavailable:
            return VoiceRecoveryPresentation(
                snapshot: snapshot(
                    summary: "Trifecta could not start the recorder.",
