...
// Purpose: Shows a compact info sheet that explains how Trifecta voice uses the paired computer's ChatGPT session.
// Layer: View
            ...
            VStack(alignment: .leading, spacing: 18) {
                HStack(spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("Trifecta does not keep a separate GPT voice login on the iPhone. It uses the ChatGPT session already active on your paired computer.")
                ...
                VStack(alignment: .leading, spacing: 12) {
                    infoStep(
                        ...
                        detail: "Trifecta records the voice clip locally on the phone when you hold to talk."
                    )
                    infoStep(
                        number: "2",
                        title: "The phone checks your paired computer",
                        detail: "Trifecta asks the paired computer bridge for the active ChatGPT session that is already connected there."
                    )
                    infoStep(
                        number: "3",
                    ...
                    infoStep(
                        number: "4",
                        title: "The text comes back to Trifecta",
