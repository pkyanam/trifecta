    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            SidebarThreadListView(
                ...
                pinnedThreadIDs: Set(codex.pinnedThreadIDs),
                loadSubagentMetadata: { threadIds in
                    await codex.loadSubagentThreadMetadataIfNeeded(threadIds: threadIds)
                }
            )
            .refreshable {
        ...
        .alert(
            ...
            Text("Chats for this project will be deleted only from Trifecta on this phone. Nothing is removed from your computer or Trifecta observer.")
        }
        .alert(
            ...
            Text("This only removes the chat from Trifecta on this phone. Nothing is removed from your computer or Trifecta observer.")
        }
        .alert(
            "Action failed",
            isPresented: Binding(
