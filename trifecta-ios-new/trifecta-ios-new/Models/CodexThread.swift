...
// Purpose: Represents a Trifecta conversation thread returned by thread/list and related events,
...
extension CodexThread {
    ...
    // Distinguishes Trifecta-managed worktrees from the main repo in compact sidebar UIs.
