...
// Purpose: Starts Trifecta reviewer runs and applies the same optimistic message bookkeeping as chat sends.
// Layer: Service
...
extension CodexService {
    ...
    // Uses the review/start target schema expected by the local Trifecta runtime.
