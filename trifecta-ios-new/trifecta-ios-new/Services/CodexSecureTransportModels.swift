...
// Purpose: Defines the wire payloads, device trust records, and crypto helpers for Trifecta E2EE.
...
let codexSecureHandshakeTag = "trifecta-e2ee-v1"
let codexSecureHandshakeLabel = "client-auth"
let codexSecureClockSkewToleranceSeconds: TimeInterval = 60
let codexTrustedSessionResolveTag = "trifecta-trusted-session-resolve-v1"
...
enum CodexSecureTransportError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidQR(let message),
            ...
            return message
        case .decryptFailed:
            return "Unable to decrypt the secure Trifecta payload."
        }
    }
}
