...
enum AppEnvironment {
    ...
    private static let supportEmailAddress = "info@belweave.com"
    ...
    static let privacyPolicyURL = URL(
        string: "https://github.com/belweave/trifecta/blob/main/Legal/PRIVACY_POLICY.md"
    )!
    static let termsOfUseURL = URL(
        string: "https://github.com/belweave/trifecta/blob/main/Legal/TERMS_OF_USE.md"
    )!
    ...
    static func feedbackMailtoURL(
        ...
        var queryItems = [
            URLQueryItem(name: "subject", value: "Share Feedback on Trifecta with the Developer")
        ]
...
private extension AppEnvironment {
    ...
    static func feedbackBody(
        ...
        if let cliVersion = sanitizedCLIVersion(cliVersion) {
            lines.append("- Trifecta CLI: \(cliVersion)")
        }
        lines.append("")
        lines.append("Notes:")
