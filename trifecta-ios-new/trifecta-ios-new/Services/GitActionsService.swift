...
enum GitActionsError: LocalizedError {
    ...
    private func userMessage(for code: String?, fallback: String?) -> String {
        ...
        case "missing_local_repo": return "Run `trifecta up` from an existing local directory first."
...
final class GitActionsService {
    ...
    // Creates a Trifecta-managed detached worktree rooted under CODEX_HOME/worktrees.
