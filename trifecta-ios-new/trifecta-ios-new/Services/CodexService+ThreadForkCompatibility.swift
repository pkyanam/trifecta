...
private extension CodexService {
    var threadForkBridgeUpdatePrompt: CodexBridgeUpdatePrompt {
        CodexBridgeUpdatePrompt(
            title: "Update Trifecta on your computer to use /fork",
            message: "This computer bridge does not support native conversation forks yet. Update the Trifecta npm package to use /fork and worktree fork flows.",
            command: nil
        )
    }
}
