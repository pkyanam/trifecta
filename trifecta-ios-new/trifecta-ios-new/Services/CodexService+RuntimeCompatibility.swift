...
private extension CodexService {
    var serviceTierBridgeUpdatePrompt: CodexBridgeUpdatePrompt {
        CodexBridgeUpdatePrompt(
            title: "Update Trifecta on your computer to use Speed controls",
            message: "This computer bridge does not support the selected speed setting yet. Update the Trifecta npm package to use Fast Mode and other speed controls.",
            command: nil
        )
    }
}
