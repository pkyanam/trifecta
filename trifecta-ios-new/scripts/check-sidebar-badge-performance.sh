...
PROJECT_PATH="$ROOT_DIR/trifecta-ios-new.xcodeproj"
SCHEME="${SCHEME:-TrifectaIOS}"
...
xcodebuild \
  ...
  test \
  -only-testing:trifecta-ios-newTests/SidebarRunBadgePerformanceTests/testSidebarRunBadgeSnapshotPerformance \
  -only-testing:trifecta-ios-newTests/SidebarRunBadgePerformanceTests/testSidebarRunBadgeSnapshotWithLargeTimelinePerformance \
  2>&1 | tee "$run_log"
