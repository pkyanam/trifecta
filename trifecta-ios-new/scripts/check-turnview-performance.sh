...
xcodebuild \
  ...
  test \
  -only-testing:trifecta-ios-newUITests/trifecta-ios-newUITests/testTurnTimelineScrollingPerformance \
  -only-testing:trifecta-ios-newUITests/trifecta-ios-newUITests/testTurnStreamingAppendPerformance \
  2>&1 | tee "$run_log"
